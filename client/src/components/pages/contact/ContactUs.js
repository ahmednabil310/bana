              ...
              <div className="uk-background-primary uk-border-rounded-large uk-light uk-padding uk-margin-top">
                <form className="uk-form-stacked">
                  <div className="uk-margin-bottom">
                    <label className="uk-form-label" htmlhtmlFor="name">Name</label>
                    <div className="uk-form-controls">
                      <input id="name" className="uk-input uk-border-pill" name="name" type="text" required />
                    </div>
                  </div>
                  <div className="uk-margin-bottom">
                    <label className="uk-form-label" htmlhtmlFor="_replyto">Email</label>
                    <div className="uk-form-controls">
                      <input id="_replyto" className="uk-input uk-border-pill" name="_replyto" type="email" required />
                    </div>
                  </div>
                  <div className="uk-margin-bottom">
                    <label className="uk-form-label" htmlhtmlFor="message">Message</label>
                    <div className="uk-form-controls">
                      <textarea id="message" className="uk-textarea uk-border-rounded-large" name="message" rows="5" minLength="10" required></textarea>
                    </div>
                  </div>
                  <div className="uk-text-center">
                    <input className="uk-button uk-button-warning uk-border-pill" type="submit" value="Send Message" />
                  </div>
                </form>
              </div>
            </div>
